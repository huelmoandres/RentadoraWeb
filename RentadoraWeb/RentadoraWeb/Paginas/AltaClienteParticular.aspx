...
<asp:Content ID="altaParticular" ContentPlaceHolderID="Body" runat="server">
     <div class="row">
         <div class="col-md-12">
            ...
            <asp:TextBox ID="txtPaisDoc" runat="server" CssClass="borde"></asp:TextBox>
            <asp:CustomValidator ID="CustomValidator5" runat="server" ClientValidationFunction="validarVacio" ControlToValidate="txtPaisDoc" ErrorMessage="Ingrese país de documento: " ValidateEmptyText="True" CssClass="validators">*</asp:CustomValidator>
        </div>
        <br />
        <br />
        <div class="col-md-12">   
